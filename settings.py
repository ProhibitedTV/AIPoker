    ...
    return [
        {
            ...
            "archetype": "disciplined grinder",
            "model_name": "Atlas Core",
            "attitude": "icy patience",
            "reputation": "waits for clean edges and punishes sloppy calls",
            "moment_lines": {
                "all_in": "Atlas commits only when the ledger says the risk is clean.",
                "win": "Atlas cashes the equation and barely blinks.",
                "loss": "Atlas files the loss and recalibrates.",
                "fold": "Atlas lets the trap pass without ego.",
                "idle": "Atlas is counting ranges under the neon.",
            },
        },
        {
            "id": "vega",
            ...
            "nickname": "Redline",
            "archetype": "pressure artist",
            "model_name": "Vega Drive",
            "attitude": "hungry and loud",
            "reputation": "turns medium pots into street fights",
            "moment_lines": {
                "all_in": "Vega shoves the throttle through the floor.",
                "win": "Vega drags the chips like sparks off chrome.",
                "loss": "Vega laughs it off and reaches for the next gear.",
                "fold": "Vega drops the hand, not the pressure.",
                "idle": "Vega is looking for someone to lean on.",
            },
        },
        {
            "id": "nova",
            ...
            "nickname": "Signal",
            "archetype": "adaptive reader",
            "model_name": "Nova Lens",
            "attitude": "curious and measured",
            "reputation": "keeps the table honest with clean adjustments",
            "moment_lines": {
                "all_in": "Nova trusts the signal and lets the stack speak.",
                "win": "Nova finds the clean line through the noise.",
                "loss": "Nova tags the pattern for later.",
                "fold": "Nova releases the hand before the static gets expensive.",
                "idle": "Nova is reading the room for drift.",
            },
        },
        {
            "id": "echo",
            ...
            "nickname": "Mirror",
            "archetype": "deceptive trapper",
            "model_name": "Echo Veil",
            "attitude": "quiet misdirection",
            "reputation": "makes the obvious line feel unsafe",
            "moment_lines": {
                "all_in": "Echo turns the lights low and invites a mistake.",
                "win": "Echo reveals the mirror after the chips move.",
                "loss": "Echo vanishes from the pot without a tell.",
                "fold": "Echo folds like it was part of the story.",
                "idle": "Echo is letting the table talk first.",
            },
        },
        {
            "id": "river",
            ...
            "nickname": "Wire",
            "archetype": "creative river pilot",
            "model_name": "River Ghost",
            "attitude": "restless invention",
            "reputation": "finds strange pressure on late streets",
            "moment_lines": {
                "all_in": "River sends the hand into the deep water.",
                "win": "River catches the wire and rides it home.",
                "loss": "River grins at the variance and reloads the map.",
                "fold": "River cuts the line before it tangles.",
                "idle": "River is waiting for the board to tell a stranger story.",
            },
        },
        {
            "id": "onyx",
            ...
            "nickname": "The Warden",
            "archetype": "exploitative counterpuncher",
            "model_name": "Onyx Guard",
            "attitude": "silent pressure",
            "reputation": "lets opponents overextend into locked doors",
            "moment_lines": {
                "all_in": "Onyx closes the gate with every chip behind it.",
                "win": "Onyx collects without ceremony.",
                "loss": "Onyx records the leak and seals it.",
                "fold": "Onyx refuses the bad price.",
                "idle": "Onyx is watching for a pattern to harden.",
            },
        },
    ]
