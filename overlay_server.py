...
const q=new URLSearchParams(location.search),directorDefault='__DIRECTOR__'==='on',directorOn=q.get('director')==='0'?false:q.get('director')==='1'?true:directorDefault,visualDebug=q.get('visual_debug')==='1'||'__VISUAL_DEBUG__'==='on',recapDuration=Number('__RECAP_DURATION__')||7500,momentDuration=Number('__MOMENT_DURATION__')||6200;
