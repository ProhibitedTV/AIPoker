...
This project includes a growing suite of unit tests. After installing the dependencies, you can run the tests using:

```bash
pytest -q
```

This will execute the test suite in the `tests/` directory and report the results. Continuous integration runs these tests automatically on pushes and pull requests via GitHub Actions.
